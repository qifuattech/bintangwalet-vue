      ...
      <v-col>
        <v-card>
          <v-card-title class="d-flex justify-space-between">
            <div class="mr-4">
              <v-btn color="success" rounded to="/penjualan/return/input"
                ><v-icon class="mr-2">mdi-plus-thick</v-icon>Tambah Return</v-btn
              >
            </div>
            <div class="mr-2">
              <v-menu
...
export default {
  ...
  methods: {
    loadDetail(no_retur) {
      this.$router.push({ path:'/penjualan/return/input', query: {noRetur: no_retur}})
    },
    async loadData() {
      this.data.items = [];
