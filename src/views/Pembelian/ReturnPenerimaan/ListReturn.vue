<template>
  <v-container>
    <v-row>
      <v-col>
        <h2>RETURN PENERIMAAN PURCHASE ORDER (PO) KE SUPPLIER</h2>
      </v-col>
    </v-row>
    <v-divider></v-divider>
    <v-row class="mt-2">
      <v-col>
        <v-card>
          <v-card-title class="d-flex justify-space-between">
            <div class="mr-4">
              <v-btn color="success" rounded to="/pembelian/return/input" ref="tambahData"
                ><v-icon>mdi-plus-thick</v-icon>Tambah Return</v-btn
              >
            </div>
            <div class="mr-2">
              <v-menu
