                  ...
                  <v-form v-model="data.isValid">
                    ...
                    <div class="d-flex justify-space-around">
                      ...
                      <v-btn
                        class="ml-2"
                        v-if="
                          customer.listOutstand == true ||
                          supplier.listOutstand == true
                        "
                        @click="showOutstand()"
                        ><v-icon>mdi-card-bulleted-outline</v-icon></v-btn
                      >
                      <!-- {{ customer.listOutstand }} - {{ supplier.listOutstand }} -->
                    </div>
    ...
    >
      <v-card class="pb-5">
        ...
        <v-card-text>
          ...
          <v-divider class="my-2"></v-divider>
          <div class="d-flex justify-end"><v-btn color="success" outlined @click="setOutstand()">OK</v-btn></div> 
...
export default {
    ...
    return {
      ...
      customer: {
        ...
        headersOutstand: [
          ...
          { text: "OUTSTAND", value: "sisa", divider: true },
          { text: "BAYAR", value: "nilai", divider: true },
          { text: "SISA", value: "kurang", divider: true },
  ...
  methods: {
    ...
    getRekening(value) {
      ...
      switch (parseInt(this.data.xjenis)) {
        case 1:
          ...
          this.supplier.listOutstand = false;
          break;
        case 2:
          this.customer.listOutstand = true;
          break;
        case 3:
          this.supplier.listOutstand = true;
          break;
    ...
    updateNilai(index) {
      ...
      this.customer.nilai = this.customer.itemsOutstand[index].nilai;
