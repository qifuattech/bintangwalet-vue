<template>
  <v-container>
    <v-row>
      <v-col>
        <div class="text-h5">MASTER KENDARAAN</div>
      </v-col>
    </v-row>
    <v-divider></v-divider>
    <!-- <v-row class="mt-2">
      ...
      <v-card class="pb-5">
        ...
        <v-card-text class="mt-3">
          <v-form v-model="addData.isValid">
            ...
            ></v-text-field> -->
            <v-text-field
              :rules="addData.rules.no_plat"
              v-model="addData.form.no_plat"
              label="Nama"
              dense
              outlined
            ></v-text-field>
            <v-text-field
              :rules="addData.rules.pabrikan"
              v-model="addData.form.pabrikan"
              label="Person"
              dense
              outlined
            ></v-text-field>
            <v-text-field
              :rules="addData.rules.nm_mobil"
              v-model="addData.form.nm_mobil"
              label="Telepon"
              dense
              outlined
            ></v-text-field>
            <v-text-field
              :rules="addData.rules.kd_customer"
              v-model="addData.form.kd_customer"
              label="Alamat"
              dense
              outlined
            ></v-text-field>
...
export default {
  ...
  data() {
    return {
      data: {
        headers: [
          { text: "NO. POLISI", value: "kode", divider: true },
          { text: "NAMA MOBIL", value: "nama", divider: true },
          { text: "PABRIKAN", value: "alamat", width: "40%", divider: true },
          { text: "PEMILIK", value: "person", divider: true },
